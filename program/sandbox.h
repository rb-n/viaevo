...
// wall-clock execution timeout - the execution machinery previously interleaved
// in Program.
//
...
public:
  ...
  // timeout_usec is the wall-clock (ITIMER_REAL) budget given to the child
  // before a SIGALRM terminates it (bounding e.g. infinite loops in evolved
  // code). Defaults to 50 ms.
  explicit Sandbox(long timeout_usec = 50000) : timeout_usec_(timeout_usec) {}
  ...
  long timeout_usec() const { return timeout_usec_; }
