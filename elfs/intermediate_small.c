...
//
// The "intermediate" part of intermediate_small refers to a small set of
// different operations between dummy variables being present in the main
// function. The "small" part of intermediate_small refers to small sizes of the
// dummy, results, and inputs arrays.
